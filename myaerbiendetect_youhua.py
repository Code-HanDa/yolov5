...
second = sleeptime(0, 0, 5) # 设置点击鼠标延时
# 这是隔5秒执行一次
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    zhongxinX = (c2[0] - c1[0]) / 2 + c1[0]
                    zhongxinY = (c2[1] - c1[1]) / 2 + c1[1]
                    print('物品位置:')
                    print('物品X坐标', zhongxinX)
                    print('物品Y坐标', zhongxinY)
                    pyautogui.click(zhongxinX, zhongxinY)
                    time.sleep(second)
